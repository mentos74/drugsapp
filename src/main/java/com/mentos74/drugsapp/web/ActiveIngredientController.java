...
//benerin upload jangan pake base64, refactor controller name
...
public class ActiveIngredientController {
    ...
    public ResponseEntity<?> editIngredient(@PathVariable Long id, @ModelAttribute ActiveIngredientDTO dto,
